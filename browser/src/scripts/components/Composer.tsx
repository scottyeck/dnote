...
//           const labelEnc = await aes256GcmEncrypt(
//             b64ToBuf(settings.cipherKey),
//             utf8ToBuf(currentBook.label)
//           );
//
//           const resp = await doCreateBook(
//             settings.sessionKey,
//             bufToB64(labelEnc)
//           );
...
//         }
//
//         const contentEnc = await aes256GcmEncrypt(
//           b64ToBuf(settings.cipherKey),
//           utf8ToBuf(content)
//         );
//         const resp = await doCreateNote(
//           settings.sessionKey,
//           bookUUID,
//           bufToB64(contentEnc)
//         );
